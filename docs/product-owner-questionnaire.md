...
*(Specific questions on entities)*
...
> 
> *(Note: You do not need to paste them here in the chat. We will save them securely to `.env.test` later. Just confirm if they are available).*
